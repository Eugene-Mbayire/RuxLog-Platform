  ...
  document.getElementById("preview-extras").innerHTML = [
    ...
    extraCard(
      ...
      hoursLines(hoursTotals || []) +
        `<p class="schedule-extra-note">Note: Each week starts with drivers owing ${WEEKLY_EXPECTED_HOURS} hours, plus last weeks owed hours or minus last weeks overtime hours. To know the CURRENT total hours that drivers owes you or the total overtime hours they worked, check the latest Sunday evening schedule.</p>`
    ),
